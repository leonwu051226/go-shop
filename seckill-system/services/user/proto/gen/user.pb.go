...
type GenerateCaptchaResponse struct {
	...
	CaptchaImage  string                 `protobuf:"bytes,4,opt,name=captcha_image,json=captchaImage,proto3" json:"captcha_image,omitempty"`
...
func (x *GenerateCaptchaResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GenerateCaptchaResponse) GetCaptchaImage() string {
	if x != nil {
...
func (x *GenerateCaptchaResponse) GetExpiresIn() int32 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
func (x *ParseTokenResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ParseTokenResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *ParseTokenResponse) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *ParseTokenResponse) GetRole() int32 {
	if x != nil {
		return x.Role
	}
	return 0
...
func (x *GetUserByIDResponse) GetData() *UserInfo {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_services_user_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x1eservices/user/proto/user.proto\x12\x04user\"i\n" +
	"\bUserInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1d\n" +
	"\n" +
	"created_at\x18\x03 \x01(\tR\tcreatedAt\x12\x12\n" +
	"\x04role\x18\x05 \x01(\x05R\x04role\"\x18\n" +
	"\x16GenerateCaptchaRequest\"\xaa\x01\n" +
	"\x17GenerateCaptchaResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x1d\n" +
	"\n" +
	"captcha_id\x18\x03 \x01(\tR\tcaptchaId\x12#\n" +
	"\rcaptcha_image\x18\x04 \x01(\tR\fcaptchaImage\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x05 \x01(\x05R\texpiresIn\"I\n" +
	...
	"\x04data\x18\x03 \x01(\v2\x0e.user.UserInfoR\x04data\"\xa5\x01\n" +
	...
	"\tclient_ip\x18\x05 \x01(\tR\bclientIp\"S\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\"\n" +
	"\x04data\x18\x03 \x01(\v2\x0e.user.UserInfoR\x04data2\xcf\x02\n" +
	"\vUserService\x12N\n" +
	"\x0fGenerateCaptcha\x12\x1c.user.GenerateCaptchaRequest\x1a\x1d.user.GenerateCaptchaResponse\x129\n" +
	...
	"\n" +
	"ParseToken\x12\x17.user.ParseTokenRequest\x1a\x18.user.ParseTokenResponse\x12B\n" +
	"\vGetUserByID\x12\x18.user.GetUserByIDRequest\x1a\x19.user.GetUserByIDResponseB(Z&seckill-system/services/user/proto/genb\x06proto3"
...
var file_services_user_proto_user_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_services_user_proto_user_proto_goTypes = []any{
	(*UserInfo)(nil),                // 0: user.UserInfo
	(*GenerateCaptchaRequest)(nil),  // 1: user.GenerateCaptchaRequest
	(*GenerateCaptchaResponse)(nil), // 2: user.GenerateCaptchaResponse
	...
	(*ParseTokenRequest)(nil),       // 7: user.ParseTokenRequest
	(*ParseTokenResponse)(nil),      // 8: user.ParseTokenResponse
...
var file_services_user_proto_user_proto_depIdxs = []int32{
	0,  // 0: user.RegisterResponse.data:type_name -> user.UserInfo
	0,  // 1: user.GetUserByIDResponse.data:type_name -> user.UserInfo
	1,  // 2: user.UserService.GenerateCaptcha:input_type -> user.GenerateCaptchaRequest
	3,  // 3: user.UserService.Register:input_type -> user.RegisterRequest
	5,  // 4: user.UserService.Login:input_type -> user.LoginRequest
	7,  // 5: user.UserService.ParseToken:input_type -> user.ParseTokenRequest
	9,  // 6: user.UserService.GetUserByID:input_type -> user.GetUserByIDRequest
	2,  // 7: user.UserService.GenerateCaptcha:output_type -> user.GenerateCaptchaResponse
	4,  // 8: user.UserService.Register:output_type -> user.RegisterResponse
	6,  // 9: user.UserService.Login:output_type -> user.LoginResponse
	8,  // 10: user.UserService.ParseToken:output_type -> user.ParseTokenResponse
	10, // 11: user.UserService.GetUserByID:output_type -> user.GetUserByIDResponse
