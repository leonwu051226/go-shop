...
const file_services_user_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x1eservices/user/proto/user.proto\x12\x04user\"U\n" +
	"\bUserInfo\x12\x0e\n" +
	...
	"\x04data\x18\x03 \x01(\v2\x0e.user.UserInfoR\x04data\"F\n" +
	...
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\"\n" +
	"\x04data\x18\x03 \x01(\v2\x0e.user.UserInfoR\x04data2\xff\x01\n" +
	"\vUserService\x129\n" +
...
var file_services_user_proto_user_proto_goTypes = []any{
	...
	(*ParseTokenRequest)(nil),   // 5: user.ParseTokenRequest
	(*ParseTokenResponse)(nil),  // 6: user.ParseTokenResponse
...
var file_services_user_proto_user_proto_depIdxs = []int32{
	...
	5, // 4: user.UserService.ParseToken:input_type -> user.ParseTokenRequest
	7, // 5: user.UserService.GetUserByID:input_type -> user.GetUserByIDRequest
	2, // 6: user.UserService.Register:output_type -> user.RegisterResponse
	4, // 7: user.UserService.Login:output_type -> user.LoginResponse
	6, // 8: user.UserService.ParseToken:output_type -> user.ParseTokenResponse
	8, // 9: user.UserService.GetUserByID:output_type -> user.GetUserByIDResponse
